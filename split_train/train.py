...
def main(args, data_dir, model_name, num_classes):
...
if __name__ == '__main__':
    ...
    model_dir = '/opt/ml/input/level1_imageclassification-cv-16/geunuk/models'
    ...
    wandb.init(
        ...
        name=f"Geun){args.model}_{args.criterion}_resize{args.resize}_crop[]_lr[{args.lr}]"
    )
    
    model_name = "Mask"
    mask_model, mask_best_score, mask_best_loss = main(args, data_dir, model_name, 3)    
    ...
    model_name = "Gender"
    gender_model, gender_best_score, gender_best_loss = main(args, data_dir, model_name, 2)
    ...
    model_name = "Age"
    age_model, age_best_score, age_best_loss = main(args, data_dir, model_name, 3)
